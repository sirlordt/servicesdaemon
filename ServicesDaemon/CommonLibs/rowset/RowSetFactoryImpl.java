...
public  final class RowSetFactoryImpl implements RowSetFactory {
	...
	public CachedRowSet createCachedRowSet() throws SQLException {
        return new rowset.CachedRowSetImpl();
    }

    @Override
	public FilteredRowSet createFilteredRowSet() throws SQLException {
        return new rowset.FilteredRowSetImpl();
    }


    @Override
	public JdbcRowSet createJdbcRowSet() throws SQLException {
        return new rowset.JdbcRowSetImpl();
    }

    @Override
	public JoinRowSet createJoinRowSet() throws SQLException {
        return new rowset.JoinRowSetImpl();
    }

    @Override
	public WebRowSet createWebRowSet() throws SQLException {
        return new rowset.WebRowSetImpl();
    }
