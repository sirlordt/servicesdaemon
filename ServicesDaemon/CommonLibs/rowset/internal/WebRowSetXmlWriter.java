...
public class WebRowSetXmlWriter implements XmlWriter, Serializable {
     ...
     */
    protected void writeRowSet(WebRowSet caller) throws SQLException {
    ...
    protected void startHeader() throws java.io.IOException {
    ...
    protected void endHeader() throws java.io.IOException {
        endTag("webRowSet");
    }
     ...
     * @exception SQLException if a database access error occurs
     */
    protected void writeProperties(WebRowSet caller) throws java.io.IOException {
     ...
     * @exception SQLException if a database access error occurs
     */
    protected void writeMetaData(WebRowSet caller) throws java.io.IOException {
        int columnCount;
    ...
    protected void writeValue(int idx, RowSet caller) throws java.io.IOException {
        try {
     ...
     *
     */
    protected void beginSection(String tag) throws java.io.IOException {
     ...
     *
     */
    protected void endSection(String tag) throws java.io.IOException {
        writeIndent(stack.size());
    ...
    protected void endSection() throws java.io.IOException {
        writeIndent(stack.size());
    ...
    protected void beginTag(String tag) throws java.io.IOException {
        // store the current tag
        setTag(tag);
    ...
    protected void endTag(String tag) throws java.io.IOException {
        String beginTag = getTag();
        if (tag.equals(beginTag)) {
            // get the current tag and write it out
            writer.write("</" + beginTag + ">\n");
    ...
    protected void emptyTag(String tag) throws java.io.IOException {
        // write an emptyTag
        writer.write("<" + tag + "/>");
    }
    ...
    protected void writeStringData(String s) throws java.io.IOException {
        if (s == null) {
            writeNull();
        } else if (s.equals("")) {
            writeEmptyString();
    ...
    protected void writeString(String s) throws java.io.IOException {
        if (s != null) {
            writer.write(s);
        } else  {
            writeNull();
    ...
    protected void writeShort(short s) throws java.io.IOException {
    ...
    protected void writeInteger(int i) throws java.io.IOException {
    ...
    protected void writeBigDecimal(java.math.BigDecimal bd) throws java.io.IOException {
        if (bd != null)
    ...
    protected void writeIndent(int tabs) throws java.io.IOException {
        // indent...
    ...
    protected void propString(String tag, String s) throws java.io.IOException {
        beginTag(tag);
        writeString(s);
        endTag(tag);
    }

    protected void propInteger(String tag, int i) throws java.io.IOException {
        beginTag(tag);
        writeInteger(i);
        endTag(tag);
    }

    protected void propBoolean(String tag, boolean b) throws java.io.IOException {
        beginTag(tag);
        writeBoolean(b);
        endTag(tag);
    }

    protected void writeEmptyString() throws java.io.IOException {
    ...
    protected String processSpecialCharacters(String s) {
