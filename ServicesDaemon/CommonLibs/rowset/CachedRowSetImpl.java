...
public class CachedRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable, Cloneable, CachedRowSet {
     ...
     */
    private String DEFAULT_SYNC_PROVIDER = "rowset.providers.RIOptimisticProvider";
    ...
    static {
    	...
    	try {
    		...
    		SyncProvider p = new rowset.providers.RIOptimisticProvider();
    		InitialContext ic = new InitialContext();
    		ic.bind ( "rowset.providers.RIOptimisticProvider", p );
    		SyncFactory.setJNDIContext( ic );
	...
	public void acceptChanges() throws SyncProviderException {
        ...
        try {
            if (rowSetWriter != null) {
                ...
                conflict = rowSetWriter.writeData(this);
                cursorPos = saveCursorPos;
            }

            if ((tXWriter) && CachedRowSet.COMMIT_ON_ACCEPT_CHANGES) {
            ...
            if (success == true) {
                setOriginal();
            } else if ( !(CachedRowSet.COMMIT_ON_ACCEPT_CHANGES)) {
        ...
        try {
            switch (trgType) {
                case java.sql.Types.BIT:
                    ...
                    return i.equals(Integer.valueOf(0)) ?
   ...
   /**
	...
	public int[] getMatchColumnIndexes() throws SQLException {
        ...
        i_val = iMatchColumns.get(0).intValue();
	...
	public void unsetMatchColumn(String columnName) throws SQLException {
        ...
        if(!((strMatchColumns.get(0)).equals(columnName))) {
            throw new SQLException(resBundle.handleGetObject("cachedrowsetimpl.unsetmatch").toString());
        } else if( (iMatchColumns.get(0)).intValue() > 0) {
