...
public class Base64OutputStream extends OutputStream {
	...
	protected void commit() throws IOException {
		if (bytecounter > 0) {
			...
			char b1 = Base64Shared.chars.charAt((buffer << 8) >>> 26);
			char b2 = Base64Shared.chars.charAt((buffer << 14) >>> 26);
			char b3 = (bytecounter < 2) ? Base64Shared.pad : Base64Shared.chars.charAt((buffer << 20) >>> 26);
			char b4 = (bytecounter < 3) ? Base64Shared.pad : Base64Shared.chars.charAt((buffer << 26) >>> 26);
