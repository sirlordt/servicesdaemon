...
public class CFakeHttpServletRequest implements HttpServletRequest {
   ...
   /**
     ...
     */
    protected LinkedHashMap<String, List<String>> headerMap =
     ...
     */
    protected LinkedHashMap<String, String[]> parametersMap = new LinkedHashMap<String, String[]>();
     ...
     */
    public CFakeHttpServletRequest(ServletContext servletContext) throws NullPointerException {
    ...
    public CFakeHttpServletRequest() {
    ...
    public long getDateHeader(String name) {
        ...
        return 0; //HeaderUtil.convertStringToDate(value);
    }

    public int getIntHeader(String name) {
        String value = getHeader(name);
        return net.maindataservices.Utilities.strToInteger(value);
    }
    ...
    public void addParameter(String name, String value) {
        ...
        if (values == null) {
            ...
            parametersMap.put(name, newArray);
        }
    }
    ...
    public void setParametersMap( LinkedHashMap<String,String> ParametersMap ) {
    	...
    	for ( Entry<String,String> Parameter: ParametersMap.entrySet() ) {
            ...
            this.parametersMap.put( Parameter.getKey(), new String[] { Parameter.getValue() });
