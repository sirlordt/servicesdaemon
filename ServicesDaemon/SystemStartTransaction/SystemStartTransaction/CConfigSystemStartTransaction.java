...
public class CConfigSystemStartTransaction extends CAbstractConfigLoader {

	protected static CConfigSystemStartTransaction SystemCommitTransactionConfig = null;

	public static CConfigSystemStartTransaction getSystemStartTransactionConfig( CConfigServicesDaemon ServicesDaemonConfig, CAbstractConfigLoader OwnerConfig, String strRunningPath ) {

		if ( SystemCommitTransactionConfig == null ) {
		
			SystemCommitTransactionConfig = new CConfigSystemStartTransaction( strRunningPath );
	...
	public CConfigSystemStartTransaction( String strRunningPath ) {
