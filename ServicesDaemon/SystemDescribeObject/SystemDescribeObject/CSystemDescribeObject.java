...
public class CSystemDescribeObject extends CDBAbstractService {
	...
	public boolean initializeService( CConfigServicesDaemon ServicesDaemonConfig, CAbstractConfigLoader OwnerConfig ) { // Alternate manual contructor
		...
		try {
			...
			this.setupService( ConstantsSystemDescribeObject._Main_File_Log, this.strRunningPath + ConstantsCommonClasses._Langs_Dir + ConstantsSystemDescribeObject._Main_File + "." + ConstantsCommonClasses._Lang_Ext ); //Init the Logger and Lang
			...
			InputParameter = new CInputServiceParameter( ConstantsSystemDescribeObject._Request_ObjectType, true, ConstantsSystemDescribeObject._Request_ObjectType_Type, ConstantsSystemDescribeObject._Request_ObjectType_Length, TParameterScope.IN, ServiceLang.translate( "Type of object to be verified its existence 1 = Table, 2 = View, 3 = Function, 4 = Stored Procedure" ) );

			ServiceInputParameters.add( InputParameter );

			InputParameter = new CInputServiceParameter( ConstantsSystemDescribeObject._Request_ObjectName, true, ConstantsSystemDescribeObject._Request_ObjectName_Type, ConstantsSystemDescribeObject._Request_ObjectName_Length, TParameterScope.IN, ServiceLang.translate( "Name of the object to be verified its existence" ) );
						...
						if ( LocalConfigDBConnection != null ) {
							...
							if ( DBEngine != null ) {
								...
								if ( DBConnection != null ) {
									...
									String strObjectType = Request.getParameter( ConstantsSystemDescribeObject._Request_ObjectType );
									...
									if ( strObjectType.equals( ConstantsSystemDescribeObject._Table ) || strObjectType.equals( ConstantsSystemDescribeObject._View ) || strObjectType.equals( ConstantsSystemDescribeObject._Function ) || strObjectType.equals( ConstantsSystemDescribeObject._Procedure ) ) {
										...
										String strObjectName = Request.getParameter( ConstantsSystemDescribeObject._Request_ObjectName );
