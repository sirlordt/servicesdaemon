...
public class CSystemRollbackTransaction extends CDBAbstractService {

	protected CConfigSystemRollbackTransaction SystemRollbackTransactionConfig = null;
	...
	public boolean initializeService( CConfigServicesDaemon ServicesDaemonConfig, CAbstractConfigLoader OwnerConfig ) { // Alternate manual contructor
		...
		try {
			...
			this.setupService( ConstantsSystemRollbackTransaction._Main_File_Log, this.strRunningPath + ConstantsCommonClasses._Langs_Dir + ConstantsSystemRollbackTransaction._Main_File + "." + ConstantsCommonClasses._Lang_Ext ); //Init the Logger and Lang
			...
			SystemRollbackTransactionConfig = CConfigSystemRollbackTransaction.getSystemRollbackTransactionConfig( ServicesDaemonConfig, OwnerConfig, this.strRunningPath );

			if ( SystemRollbackTransactionConfig.LoadConfig( this.strRunningPath + ConstantsSystemRollbackTransaction._Conf_File, ServiceLang, ServiceLogger ) == true ) {
							...
							if ( DBEngine != null ) {
								...
								/*}                        
									...
									try {
										...
										String strResponseBuffer = ResponseFormat.FormatSimpleMessage( "", "", -1004, ServiceLang.Translate( "Failed to rollback transaction for id: [%s], see the log file for more details", strSecurityTokenID ), true, strResponseFormatVersion, LocalConfigDBConnection.strDateTimeFormat, LocalConfigDBConnection.strDateFormat, LocalConfigDBConnection.strTimeFormat, this.ServiceLogger!=null?this.ServiceLogger:this.OwnerLogger, this.ServiceLang!=null?this.ServiceLang:this.OwnerLang );
										Response.getWriter().print( strResponseBuffer );
								...
								try {
									...
									String strResponseBuffer = ResponseFormat.formatSimpleMessage( "", "", -1003, ServiceLang.translate( "Failed to rollback transaction for id: [%s], see the log file for more details", strSecurityTokenID ), true, strResponseFormatVersion, LocalConfigDBConnection.strDateTimeFormat, LocalConfigDBConnection.strDateFormat, LocalConfigDBConnection.strTimeFormat, this.ServiceLogger!=null?this.ServiceLogger:this.OwnerLogger, this.ServiceLang!=null?this.ServiceLang:this.OwnerLang );
									Response.getWriter().print( strResponseBuffer );
