...
public class CConfigSystemRollbackTransaction extends CAbstractConfigLoader {

	protected static CConfigSystemRollbackTransaction SystemRollbackTransactionConfig = null;

	public static CConfigSystemRollbackTransaction getSystemRollbackTransactionConfig( CConfigServicesDaemon ServicesDaemonConfig, CAbstractConfigLoader OwnerConfig, String strRunningPath ) {
		
		if ( SystemRollbackTransactionConfig == null ) {
			
			SystemRollbackTransactionConfig = new CConfigSystemRollbackTransaction( strRunningPath );
			
		}
		
		SystemRollbackTransactionConfig.OwnerConfig = OwnerConfig;
	...
	public CConfigSystemRollbackTransaction( String strRunningPath ) {
